...
- Keep entities in a dedicated `Ploch.{Product}.Model` project and namespace — singular `Model`, never `Models` or `DomainModel`. See [`project-naming.md`](./project-naming.md) for the full naming rule and the migration list for existing projects.
